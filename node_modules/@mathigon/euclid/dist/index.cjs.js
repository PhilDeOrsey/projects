...
var Point = class _Point {
  ...
  get unitVector() {
    if ((0, import_fermat2.nearlyEquals)(this.length, 0)) return new _Point(1, 0);
  ...
  snap(p, tolerance = 5) {
    if ((0, import_fermat2.nearlyEquals)(this.x, p.x, tolerance)) return new _Point(p.x, this.y);
    if ((0, import_fermat2.nearlyEquals)(this.y, p.y, tolerance)) return new _Point(this.x, p.y);
    return this;
  }
  ...
  rotate(angle, c = ORIGIN) {
    if ((0, import_fermat2.nearlyEquals)(angle, 0)) return this;
    const x0 = this.x - c.x;
    const y0 = this.y - c.y;
...
var Line = class _Line {
  ...
  rotate(a, c = ORIGIN) {
    if ((0, import_fermat3.nearlyEquals)(a, 0)) return this;
...
var Circle = class _Circle {
  ...
  rotate(a, c = ORIGIN) {
    if ((0, import_fermat4.nearlyEquals)(a, 0)) return this;
...
var Arc = class {
  ...
  rotate(a, c = ORIGIN) {
    if ((0, import_fermat5.nearlyEquals)(a, 0)) return this;
    return new this.constructor(
      this.c.rotate(a, c),
...
function liesOnSegment(s, p) {
  if ((0, import_fermat6.nearlyEquals)(s.p1.x, s.p2.x)) return (0, import_fermat6.isBetween)(p.y, s.p1.y, s.p2.y);
  return (0, import_fermat6.isBetween)(p.x, s.p1.x, s.p2.x);
}
function liesOnRay(r, p) {
  if ((0, import_fermat6.nearlyEquals)(r.p1.x, r.p2.x)) return (p.y - r.p1.y) / (r.p2.y - r.p1.y) > 0;
  return (p.x - r.p1.x) / (r.p2.x - r.p1.x) > 0;
}
function liesOnArc(a, p) {
  return (0, import_fermat6.isBetween)(a.offset(p), 0, 1);
}
function lineLineIntersection(l1, l2) {
  ...
  if ((0, import_fermat6.nearlyEquals)(d, 0)) return [];
...
function circleCircleIntersection(c1, c2) {
  ...
  if ((0, import_fermat6.nearlyEquals)(d, 0) && (0, import_fermat6.nearlyEquals)(c1.r, c2.r)) return [];
  if ((0, import_fermat6.nearlyEquals)(d, c1.r + c2.r)) return [new Line(c1.c, c2.c).midpoint];
  const a = ((0, import_fermat6.square)(c1.r) - (0, import_fermat6.square)(c2.r) + (0, import_fermat6.square)(d)) / (2 * d);
  const b = Math.sqrt((0, import_fermat6.square)(c1.r) - (0, import_fermat6.square)(a));
...
function lineCircleIntersection(l, c) {
  ...
  const dr2 = (0, import_fermat6.square)(dx) + (0, import_fermat6.square)(dy);
  const cx = c.c.x;
  const cy = c.c.y;
  const D = (l.p1.x - cx) * (l.p2.y - cy) - (l.p2.x - cx) * (l.p1.y - cy);
  const disc = (0, import_fermat6.square)(c.r) * dr2 - (0, import_fermat6.square)(D);
  if (disc < 0) return [];
  const xa = D * dy / dr2;
  const ya = -D * dx / dr2;
  if ((0, import_fermat6.nearlyEquals)(disc, 0)) return [c.c.shift(xa, ya)];
...
function intersections(...elements) {
  ...
  if (elements.length > 2) {
    return (0, import_core2.flatten)((0, import_fermat6.subsets)(elements, 2).map((e) => intersections(...e)));
  }
  let [a, b] = elements;
...
var Polygon = class _Polygon {
  ...
  get circumference() {
    ...
    let length = Point.distance(this.points[0], (0, import_core3.last)(this.points));
  ...
  static regular(n, radius = 1) {
    ...
    const points = (0, import_core3.tabulate)((i) => Point.fromPolar(a0 + da * i, radius), n);
  ...
  rotate(a, center = ORIGIN) {
    if ((0, import_fermat7.nearlyEquals)(a, 0)) return this;
...
var Angle = class _Angle {
  ...
  static equals(a, b, precision = Math.PI / 360) {
    return (0, import_fermat8.nearlyEquals)(a.rad, b.rad, precision);
  }
  ...
  get isRight() {
    return (0, import_fermat8.nearlyEquals)(this.rad, Math.PI / 2, Math.PI / 360);
  }
  ...
  get radius() {
    return 24 + 20 * (1 - (0, import_fermat8.clamp)(this.rad, 0, Math.PI) / Math.PI);
  }
  ...
  rotate(a, c) {
    if ((0, import_fermat8.nearlyEquals)(a, 0)) return this;
...
var Rectangle = class _Rectangle {
  ...
  // ---------------------------------------------------------------------------
  contains(p, tolerance) {
    return (0, import_fermat9.isBetween)(p.x, this.p.x, this.p.x + this.w, tolerance) && (0, import_fermat9.isBetween)(p.y, this.p.y, this.p.y + this.h, tolerance);
  }
  project(p) {
    let q = void 0;
    for (const e of this.edges) {
  ...
  rotate(a, c = ORIGIN) {
    if ((0, import_fermat9.nearlyEquals)(a, 0)) return this;
...
var Bounds = class _Bounds {
  ...
  containsX(p) {
    return (0, import_fermat10.isBetween)(p.x, this.xMin, this.xMax);
  }
  containsY(p) {
    return (0, import_fermat10.isBetween)(p.y, this.yMin, this.yMax);
  }
  resize(dx, dy) {
...
function drawLineArrows(x, type) {
  let path = "";
  if ((0, import_core4.isOneOf)(type, "start", "both")) {
    path += arrowPath(x.p1, x.unitVector);
  }
  if ((0, import_core4.isOneOf)(type, "end", "both")) {
...
function getBezierPoints(points, radius) {
  ...
  const p1 = Point.interpolate(points[0], points[1], (0, import_fermat11.clamp)(1 - d1, 0, 1));
  const p2 = Point.interpolate(points[0], points[1], (0, import_fermat11.clamp)(1 - d1 * shift, 0, 1));
  const p3 = Point.interpolate(points[1], points[2], (0, import_fermat11.clamp)(d2 * shift, 0, 1));
  const p4 = Point.interpolate(points[1], points[2], (0, import_fermat11.clamp)(d2, 0, 1));
  return [p1, p2, p3, p4];
}
